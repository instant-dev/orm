...
class PostgresAdapter extends SQLAdapter {
  ...
  async connectToTunnel () {
    ...
    if (config.tunnel) {
      tunnelObject = await this.db.createTunnelFromConfig(config);
...
PostgresAdapter.prototype.comparators = {
  ...
  not_contains: field => `${field} NOT LIKE '%' || __VAR__ || '%'`,
  icontains: field => `${field} ILIKE '%' || __VAR__ || '%'`,
  not_icontains: field => `${field} NOT ILIKE '%' || __VAR__ || '%'`,
  startswith: field => `${field} LIKE __VAR__ || '%'`,
  not_startswith: field => `${field} NOT LIKE __VAR__ || '%'`,
  istartswith: field => `${field} ILIKE __VAR__ || '%'`,
  not_istartswith: field => `${field} NOT ILIKE __VAR__ || '%'`,
  endswith: field => `${field} LIKE '%' || __VAR__`,
  not_endswith: field => `${field} NOT LIKE '%' || __VAR__`,
  iendswith: field => `${field} ILIKE '%' || __VAR__`,
  not_iendswith: field => `${field} NOT ILIKE '%' || __VAR__`,
  like: field => `${field} LIKE __VAR__`,
  not_like: field => `${field} NOT LIKE __VAR__`,
  ilike: field => `${field} ILIKE __VAR__`,
  not_ilike: field => `${field} NOT ILIKE __VAR__`,
